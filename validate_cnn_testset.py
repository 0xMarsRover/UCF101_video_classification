...
def main(nb_images=5):
    ...
    test_data_num = 186640 #the number of test images
    batch_size = 32
    test_generator = test_data_gen.flow_from_directory('/data/d14122793/UCF101_Video_Classi/data/test/', target_size=(299, 299),
    ...
    model = load_model('/data/d14122793/UCF101_Video_Classi/data/checkpoints/inception.020-0.81.hdf5')
